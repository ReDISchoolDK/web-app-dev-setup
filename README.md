...
```bash
curl -fsSL https://raw.githubusercontent.com/ReDISchoolDK/wad-setup/main/setup-mac.sh -o /tmp/setup.sh && bash /tmp/setup.sh
```
...
```powershell
irm https://raw.githubusercontent.com/ReDISchoolDK/wad-setup/main/setup-windows.ps1 | iex
```
